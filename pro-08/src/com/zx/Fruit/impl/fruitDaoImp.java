...
public class fruitDaoImp implements fruitDao {
    ...
    //获取数据库中所有水果
    @Override
    public List<Fruit> QueryList(Connection connection,int pageNumber,String keyword) {
    ...
    //根据id查询单条水果数据
    @Override
    public Fruit Query(Connection connection, int id) {
    ...
    @Override
    public boolean insert(Connection connection, Fruit fruit) {
    ...
    @Override
    public Long count(Connection connection,String keyword) {
    ...
    @Override
    public boolean update(Connection connection, Fruit fruit) {
    ...
    @Override
    public boolean del(Connection connection, int id) {
