...
import com.zx.qqzone.qqexception.ZoneException;
...
public class ReplyController {
    ...
    public String addReply(String replyId, String content, HttpSession session) {
        ...
        Date reDate = null;
        try {
            reDate = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(dateString);
        } catch (ParseException e) {
            throw new ZoneException("时间转换异常");
        }

        Timestamp ReplyDate = new Timestamp(reDate.getTime());
    ...
    public String addHostReply(String content, Integer id, Integer ReplyId, HttpSession session) {
        ...
        Timestamp hostReplyDate = new Timestamp(reDate.getTime());
