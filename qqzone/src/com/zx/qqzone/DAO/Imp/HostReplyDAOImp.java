...
public class HostReplyDAOImp implements HostReplyDAO {
    ...
    public HostReply getHostReplyById(Reply reply) {
        try {
            ...
            return queryRunner.query(ContUtils.getConnections(), sql, beanHandler, reply.getId());
    ...
    public HostReply getHostReplyById(Integer replyId) {
        try {
            ...
            return queryRunner.query(ContUtils.getConnections(), sql, beanHandler, replyId);
        } catch (SQLException e) {
            e.printStackTrace();
        }
        return null;
    ...
    public void addHostReply(HostReply hostReply) {
        try {
            ...
            queryRunner.update(ContUtils.getConnections(), sql, hostReply.getContent(), hostReply.getHostReplyDate(), hostReply.getAuthor(), hostReply.getReply());
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
    ...
    public void delHostReply(Integer ReplyId) {
        try {
            ...
            queryRunner.update(ContUtils.getConnections(), sql, ReplyId);
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
