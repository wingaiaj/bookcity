...
public class ReplyDAOImp implements ReplyDAO {
    ...
    public List<Reply> getReplyList(Integer topicId) {
        try {
            ...
            List<Reply> replyList = queryRunner.query(ContUtils.getConnections(), sql, beanListHandler, topicId);
            return replyList;
    ...
    public void addReply(Reply reply) {
        ...
        try {
            ...
            queryRunner.update(ContUtils.getConnections(), sql, reply.getContent(), reply.getReplyDate(), reply.getAuthor(), reply.getTopic());
        } catch (SQLException e) {
            e.printStackTrace();
        }
