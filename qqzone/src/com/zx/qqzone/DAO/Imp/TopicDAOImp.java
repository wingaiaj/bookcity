...
public class TopicDAOImp implements TopicDAO {
    ...
    public List<Topic> getTopicList(BasicUser basicUser) {
        try {
            ...
            return queryRunner.query(ContUtils.getConnections(), sql, beanListHandler, basicUser.getId());
    ...
    public void addTopic(Topic topic) {
        try {
            ...
            queryRunner.update(ContUtils.getConnections(), sql, topic.getTitle(), topic.getContent(), topic.getTopicDate(), topic.getAuthor());
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
    ...
    public void delTopic(Integer topicId) {
        ...
        try {
            ...
            queryRunner.update(ContUtils.getConnections(), sql, topicId);
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
    ...
    public Topic getTopic(Integer id) {
        try {
            ...
            return queryRunner.query(ContUtils.getConnections(), sql, beanHandler, id);
        } catch (SQLException e) {
            e.printStackTrace();
        }
        return null;
